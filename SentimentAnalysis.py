...
class TwitterClient(object): 
    ...
    def clean_tweet1(self, tweet): 
       ...
       return " ".join([i for i in re.sub(r'[^a-zA-Z\s]', "", tweet).lower().split() if i not in stopword_set])
       
       #return tweet
    
   
    def get_tweet_sentiment(self, tweet): 
      #implementing vader sentiment analyzer
    ...
    def get_tweets(self, query, count = 10): 
        ...
        try: 
            ...
            for tweet in fetched_tweets: 
                ...
                sre=TwitterClient.clean_tweet(self,tweet.text)
                #se=TwitterClient.clean_tweet1(self,tweet.text)
                parsed_tweet['sentiment'] = self.get_tweet_sentiment(sre) 
    ...
    def get_tweets1(self, query, count = 10): 
        ...
        try: 
            ...
            for tweet in fetched_tweets: 
                ...
                #sre=TwitterClient.clean_tweet(self,tweet.text)
                se=TwitterClient.clean_tweet1(self,tweet.text)
                parsed_tweet['sentiment'] = self.get_tweet_sentiment(se) 
...
def main(): 
    ...
    print("Positive tweets after pre-processing percentage Modi: {} %".format(100*len(ptweets1)/len(tweets1)))
    print("Positive tweets after pre-processing percentage Rahul Gandhi: {} %".format(100*len(ptweets2)/len(tweets2)))
    ...
    print("Negative tweets after pre-processing percentage Modi: {} %".format(100*len(ntweets1)/len(tweets1)))
    print("Negative tweets after pre-processing percentage Rahul: {} %".format(100*len(ntweets2)/len(tweets2)))
    ...
    print("\n\nNegative tweets Modi:") 
    for tweet in ntweets1[:1000]: 
        print(tweet['text'].translate(non_bmp_map))
    print("\n\nNegative tweets Rahul:")     
    for tweet in ntweets2[:1000]: 
        print(tweet['text'].translate(non_bmp_map))
    plt.title('View towards Narendra Modi')    
    labels = ['Positive', 'Negative', 'Neutral']
    sizes = [format(100*len(ptweets1)/len(tweets1)),format(100*len(ntweets1)/len(tweets1)),format(100*(len(tweets1)-len(ntweets1)-len(ptweets1))/len(tweets1))]
    ...
    sizes1 = [format(100*len(ptweets2)/len(tweets2)),format(100*len(ntweets2)/len(tweets2)),format(100*(len(tweets2)-len(ntweets2)-len(ptweets2))/len(tweets2))]
